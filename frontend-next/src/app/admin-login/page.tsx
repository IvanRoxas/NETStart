      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="bg-[#1a082c] border border-white/10 rounded-2xl p-8 shadow-xl">
          <div className="flex flex-col items-center text-center mb-8">
            <h1 className="text-xl font-bold text-white tracking-wide">NETStart: Admin Portal</h1>
          </div>
          ...
          <form onSubmit={handleAdminLogin} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-black/20 text-white text-sm pl-10 pr-10 py-2.5 rounded-lg border border-white/10 outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full mt-2 bg-indigo-500 hover:bg-indigo-600 text-white font-medium text-sm py-3 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center cursor-pointer"
            >
              {loading ? (
