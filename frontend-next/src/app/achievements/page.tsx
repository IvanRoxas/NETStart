                ...
                {viewAllCategory.badges.map((baseBadge) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex flex-col items-center gap-3 p-4 rounded-xl border transition-all ${isUnlocked
            ...
            <div className="flex flex-col flex-1 items-center md:items-start w-full">
              ...
              {selectedBadge.isUnlocked ? (
                <button
                  ...
                  className={`font-bold py-3 px-8 rounded-full w-full md:w-auto transition-colors active:scale-95 ${!showcasedBadges.includes(selectedBadge.id) && showcasedBadges.length >= 6
