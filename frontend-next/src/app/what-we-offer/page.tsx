...
const services = [
  ...
  { id: '02', title: 'Blockly Visual Sandbox', icon: 'M13 10V3L4 14h7v7l9-11h-7z', highlight: true, desc: 'Build programs with visual code logic block-rendering that translates directly into functional text-based languages.' },
